...
class PerawatControlller extends Controller
{
    ...
    {
        $record = Perawat::all(); // Retrieve all from the database
        return view('pages.perawat.index', ['perawat' => $record , 'type_menu' => '']);
    }
    ...
    Log::info('Variable data:', $imagePath);
    ...
    $model->foto_perawat = $imagePath ?? null; 
    $model->save();
