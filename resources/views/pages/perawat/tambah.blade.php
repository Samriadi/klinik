                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="form-group">
                                ...
                                <form action="/store-perawat" method="post" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nip_perawat" id="nip_perawat">
                                    </div>
                                    <div class="mb-3">
                                        <label for="nohp_perawat" class="form-label">Nomor HP Perawat</label>
                                        <input type="text" class="form-control" name="nohp_perawat" id="nohp_perawat">
                                    </div>
                                    <div class="mb-3">
